...
NOISEMAP_OUT = NOISEMAP_DIR / "Data" / "ville_noisemap.ply"
...
def main():
    ...
    if args.no_compare:
        return
    try:
        run_noisemap(args.drone, args.x, args.y, args.z)
