...
Usage :
    ...
    python3 models/GAT/optuna/optuna_runs/feat23_withREF/ana_arch/analyze_arch_influence.py --study gat-arch-v2 --db models/GAT/optuna/optuna_runs/feat23_withREF/ana_arch/gat-arch-v2.db --out ./figures
"""
