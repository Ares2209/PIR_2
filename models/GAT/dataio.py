...
def build_loaders(graphs, split, batch_size: int, env, seed: int):
    ...
    don't need cross-rank gathering. `env` is a `DistEnv`."""
    ...
    val_loader  = DataLoader(val_set,  batch_size=batch_size, pin_memory=pin)
    test_loader = DataLoader(test_set, batch_size=batch_size, pin_memory=pin)
